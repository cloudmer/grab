...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li class="active"><span>包含号码报警设置</span></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                ...
                <div class="btn-group pull-right">
                    <button data-toggle="dropdown" data-url="/admin/interval/form" class="btn btn-primary dropdown-toggle has-tooltip add-reserve" type="button" title="" data-original-title="Labels">
            ...
            <div class="main-box-body clearfix">
                <div class="table-responsive">
                    <table id="table-example-fixed" class="table table-hover">
                        ...
                        <tbody>
                        <?= $this->render('/admin/interval/_list',['model'=>$model]) ?>
                        </tbody>
                    </table>
                </div>
            </div>
