        ...
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                ...
                <div class="btn-group pull-right">
                    <button data-toggle="dropdown" data-url="/admin/packet/form?type=<?php echo $type;?>" class="btn btn-primary dropdown-toggle has-tooltip add-reserve" type="button" title="" data-original-title="Labels">
            ...
            <div class="main-box-body clearfix">
                <div class="table-responsive">
                    <table id="table-example-fixed" class="table table-hover">
                        ...
                        <tbody>
                        <?= $this->render('/admin/packet/_list',['type'=>$type,'model'=>$model]) ?>
                        </tbody>
                    </table>
                </div>
            </div>
