...
<table class="table table-hover">
    ...
    <?= $this->render('_list',['model'=>$model,'cycle'=>$cycle])?>
...
<div class="text-center more" style="margin-bottom: 30px" data-page="2" data-url="<?= \yii\helpers\Url::to('/home/xj-statistics')?>">
    <span style="padding: 9px 31px;" class="label label-success">加载更多</span>
</div>

<div class="text-center null" style="display: none;margin-bottom: 30px" data-page="2" data-url="<?= \yii\helpers\Url::to('/home/xj-statistics')?>">
