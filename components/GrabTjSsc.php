...
class GrabTjSsc
{
    ...
    private function forever_notice(){
        ...
        //天津时时彩 数据包1分析
        $analysisTjsscsData1 = $new_data->analysisTjsscsData1;
        $analysisTjsscsData1->front_three_lucky_txt
            ? $q3 = '中奖'
            : $q3 = '未中奖' ;

        $analysisTjsscsData1->center_three_lucky_txt
            ? $z3 = '中奖'
            : $z3 = '未中奖' ;

        $analysisTjsscsData1->after_three_lucky_txt
            ? $h3 = '中奖'
            : $h3 = '未中奖' ;
        ...
        //天津时时彩 数据包2分析
        $analysisTjsscsData2 = $new_data->analysisTjsscsData2;
        $analysisTjsscsData2->front_three_lucky_txt
            ? $q3 = '中奖'
            : $q3 = '未中奖' ;

        $analysisTjsscsData2->center_three_lucky_txt
            ? $z3 = '中奖'
            : $z3 = '未中奖' ;

        $analysisTjsscsData2->after_three_lucky_txt
            ? $h3 = '中奖'
            : $h3 = '未中奖' ;
    ...
    private function danger($regret_number){
        ...
        foreach ($newestCodes as $obj){
            //天津时时彩 数据包1 数据分析
            $analysisTjsscsData1 = $obj->analysisTjsscsData1;
            //当前 N 期内 前三号码 中过奖
            if($analysisTjsscsData1->front_three_lucky_txt){
                $q3_data1_lucky = true;
            }
            //当前 N 期内 中三号码 中过奖
            if($analysisTjsscsData1->center_three_lucky_txt){
                $z3_data1_lucky = true;
            }
            //当前 N 期内 后三号码 中过奖
            if($analysisTjsscsData1->after_three_lucky_txt){
                $h3_data1_lucky = true;
            }

            //天津时时彩 数据包2 数据分析
            $analysisTjsscsData2 = $obj->analysisTjsscsData2;
            //当前 N 期内 前三号码 中过奖
            if($analysisTjsscsData2->front_three_lucky_txt){
                $q3_data2_lucky = true;
            }
            //当前 N 期内 中三号码 中过奖
            if($analysisTjsscsData2->center_three_lucky_txt){
                $z3_data2_lucky = true;
            }
            //当前 N 期内 后三号码 中过奖
            if($analysisTjsscsData2->after_three_lucky_txt){
                $h3_data2_lucky = true;
            }
        }
        ...
        */
        ...
        $mail_contents = '<a href="http://'.$_SERVER['SERVER_NAME'].'">传送门--->小蛮牛数据平台</a><br/>'
            ...
            */
            .'通知类型:津 当前'.$regret_number.'期 报警提示<br/>'
            .'前: '.$q3_data1_msg.'<br/>'
            .'中: '.$z3_data1_msg.'<br/>'
