...
/**
 * This is the model class for table "bjssc".
 *
 * @property integer $id
 ...
 *
 * @property AnalysisBjssc[] $analysisBjsscs
 */
class Bjssc extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function getAnalysisBjsscs()
    {
        return $this->hasOne(AnalysisBjssc::className(), ['bjssc_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(AnalysisBjssc::className(), ['bjssc_id' => 'id'])->where(['type'=>$data_txt_id]);
    }
